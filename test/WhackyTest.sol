...
import {NovelOrigination} from "starport-core/NovelOrigination.sol";
...
contract WhackyTest is StarPortTest {
    Account recaller;
    address recallerConduit;
    bytes32 conduitKeyRecaller;

    NovelOrigination origination;
    ...
    function setUp() public override {
        ...
        origination = new NovelOrigination(LM);
        borrowerEnforcer = new BorrowerEnforcer();
        lenderEnforcer = new LenderEnforcer();
        vm.label(address(origination), "NovelOrigination");
