...
contract DutchAuctionHandler is SettlementHandler, AmountDeriver {
    ...
    function getSettlement(
    ...
    ) external view virtual override returns (ReceivedItem[] memory consideration, address restricted) {
        ...
        uint256 fee = settlementPrice.mulWad(Originator(loan.originator).strategistFee());
