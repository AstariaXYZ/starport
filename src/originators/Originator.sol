...
abstract contract Originator {
    ...
    function validate(LoanManager.Loan calldata, bytes calldata, Signature calldata)
        external
        view
        virtual
    ...
    {
        bytes32 hash = keccak256(abi.encode(ORIGINATOR_DETAILS_TYPEHASH, _counter[account], keccak256(context)));
